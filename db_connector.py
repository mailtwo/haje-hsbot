...
hs_expansion_group = {
    '정확': [],
    '정규': ['마녀숲', '폭심만만', '라스타칸의 대난투', '어둠의 반격', '울둠의 구원자', '용의 강림', '오리지널', '기본'],
    '야생': ['대 마상시합', '명예의 전당', '낙스라마스', '고블린 대 노움', '검은바위 산', '탐험가 연맹', '가젯잔', '카라잔', '고대 신', '운고로', '코볼트', '얼어붙은 왕좌'],
    '모험모드': ['낙스라마스 모험모드', '검은바위 산 모험모드', '탐험가 연맹 모험모드', '카라잔 모험모드', '얼어붙은 왕좌 모험모드', '코볼트 모험모드', '마녀숲 모험모드', '시간의 선술집', '라스타칸의 대난투 모험모드', '어둠의 반격 모험모드']
}
